...
class Ficha:
    def __init__(self, Xposition, Yposition, Display):
        self.image = pygame.image.load("Ficha_Naranja.png")
    ...
    def transform_ficha(self, ubication="Ficha_Naranja_Reina.png"):
    ...
    def select_pieces(self, Xposition, Yposition, Display):
        if self.queen_status:
            self.image = pygame.image.load("Seleccion_Ficha_Naranja_Reina.png")
            Display.blit(self.image, (Xposition, Yposition))
            pygame.display.flip()
        else:
            self.image = pygame.image.load("Seleccion_Ficha_Naranja.png")
            Display.blit(self.image, (Xposition, Yposition))
            pygame.display.flip()
    ...
    def after_selection(self, ubication="Ficha_Naranja.png"):
        if self.queen_status:
            self.image = pygame.image.load("Ficha_Naranja_Reina.png")
            pygame.display.flip()
        else:
            self.image = pygame.image.load(ubication)
            pygame.display.flip()
...
class Op_Ficha(Ficha):
    ...
    def select_pieces(self, Xposition, Yposition, Display):
        if self.queen_status:
            self.imageop = pygame.image.load("Seleccion_Ficha_Azul_Reina.png")
    ...
    def after_selection(self, ubication="Ficha_Azul.png"):
        if self.queen_status:
            self.imageop = pygame.image.load("Ficha_Azul_Reina.png")
            pygame.display.flip()
        else:
            self.imageop = pygame.image.load(ubication)
            pygame.display.flip()
...
class Tablero:
    def __init__(self, Display):
        self.board_image = pygame.image.load("tablero_original.png")
